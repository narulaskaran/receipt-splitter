...
export function ReceiptDetails({ receipt, onReceiptUpdate }: ReceiptDetailsProps) {
  ...
  const handleSave = () => {
    ...
    if (updatedReceipt.tip === null) {
      updatedReceipt.tip = Math.max(0, updatedReceipt.total - updatedReceipt.subtotal - updatedReceipt.tax);
    }
      ...
      <CardContent>
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <p className="font-medium font-bold">{formatCurrency(receipt.total)}</p>
          </div>
        </div>
      </CardContent>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="grid gap-2">
                ...
                <Input
                  id="date"
                  type="date"
                  value={editedReceipt.date ? editedReceipt.date.substring(0, 10) : ''}
                  onChange={(e) => setEditedReceipt({
                    ...editedReceipt,
